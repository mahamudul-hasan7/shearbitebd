...
export function createMockAppState(now = new Date()): MockAppState {
  ...
  return {
    ...
    claims: [
      { id: "claim-uiu-lunch", donationId: "donation-uiu-lunch", ngoProfileId: "ngo-hope", volunteerProfileId: "volunteer-demo", status: ClaimStatus.PICKED_UP, matchScore: 96, reservedAt: relativeIso(baseTime, -25), assignedAt: relativeIso(baseTime, -15), pickedUpAt: relativeIso(baseTime, -5), estimatedPickupAt: relativeIso(baseTime, -5), estimatedDeliveryAt: relativeIso(baseTime, 45), pickupVerificationToken: "MOCK-PICKUP-624819", deliveryVerificationToken: "MOCK-DELIVERY-381507", updatedAt: relativeIso(baseTime, -5) },
      { id: "claim-banani-bread", donationId: "donation-banani-bread", ngoProfileId: "ngo-hope", status: ClaimStatus.RESERVED, matchScore: 86, reservedAt: relativeIso(baseTime, -15), estimatedPickupAt: relativeIso(baseTime, 150), updatedAt: relativeIso(baseTime, -15) },
    ...
    requests: [
      { id: "request-hope-family-meals", ngoProfileId: "ngo-hope", title: "Evening meals for shelter families", requestType: RequestType.ONE_TIME, priority: PriorityLevel.HIGH, priorityReason: "The regular meal sponsor is unavailable today.", supportingDocumentNames: ["shelter-meal-plan.pdf"], purpose: "Evening meal support", recipientType: "Families", categories: [FoodCategory.COOKED_MEAL, FoodCategory.BAKERY], dietaryTypes: [DietaryType.HALAL], specificPreferences: "Individually packed portions are preferred.", allergensOrRestrictions: ["Clearly label milk and nut allergens"], peopleToServe: 80, mealsNeeded: 80, neededWhen: "TODAY", neededBy: relativeIso(baseTime, 600), preferredTimeSlot: "6:00 PM - 8:00 PM", deliveryAddressId: "address-hope", locationType: "SHELTER", deliveryLocation: { addressLine: "House 12, Road 4", area: "Badda", city: "Dhaka", landmark: "Near the community clinic", instructions: "Call the NGO desk on arrival." }, notes: "Portions suitable for adults and children are welcome.", status: RequestStatus.FINDING_MATCH, createdAt: relativeIso(baseTime, -200), updatedAt: relativeIso(baseTime, -120) },
      { id: "request-community-weekend", ngoProfileId: "ngo-community-kitchen", title: "Weekend community lunch supplies", requestType: RequestType.RECURRING, priority: PriorityLevel.MEDIUM, supportingDocumentNames: [], purpose: "Community lunch preparation", recipientType: "Community outreach", categories: [FoodCategory.GROCERIES, FoodCategory.PRODUCE], dietaryTypes: [DietaryType.HALAL, DietaryType.VEGETARIAN], allergensOrRestrictions: [], peopleToServe: 150, mealsNeeded: 150, neededWhen: "CUSTOM", neededBy: relativeIso(baseTime, 2_880), preferredTimeSlot: "Friday morning", deliveryAddressId: "address-community-kitchen", locationType: "COMMUNITY_CENTER", deliveryLocation: { addressLine: "Community Kitchen, Road 8", area: "Rampura", city: "Dhaka", landmark: "Beside the public library" }, status: RequestStatus.PENDING_REVIEW, createdAt: relativeIso(baseTime, -90), updatedAt: relativeIso(baseTime, -90) },
    ],
    notifications: [
